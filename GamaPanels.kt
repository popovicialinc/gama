...
fun SettingsPanel(
    ...
    PanelScaffold(
        ...
        AnimatedElement(visible = visible, staggerIndex = 4, totalItems = 4) {
            SettingsNavigationCard(
                title = "LANGUAGE",
                description = "Change the display language of the GAMA interface",
...
fun LanguagePanel(
    ...
    LaunchedEffect(visible) {
        if (visible && availableLanguages.isEmpty()) {
    ...
    PanelScaffold(
        ...
        AnimatedElement(visible = visible, staggerIndex = 3, totalItems = 3) {
            Column(
                ...
                Text(
                    text       = "⟳  Restart GAMA for all changes to take full effect",
                    fontSize   = ts.bodySmall,
                    color      = colors.textSecondary.copy(alpha = 0.4f),
                    fontFamily = quicksandFontFamily,
                    fontWeight = FontWeight.Medium
                ...
                Text(
                    text       = "Add new languages by dropping a JSON file into assets/translations/",
                    fontSize   = ts.bodySmall,
                    color      = colors.textSecondary.copy(alpha = 0.28f),
                    fontFamily = quicksandFontFamily,
                    fontWeight = FontWeight.Medium
                )
            }
